...
# ros2 launch create3_navigation localization.launch.py 'map:=/home/ubuntu/wali_pi4/c3ws/maps/floorplan/floorplan.map.yaml'
# ros2 launch create3_navigation localization.launch.py 'map:=/home/ubuntu/wali_pi4/c3ws/maps/xyzzy.map.yaml'
